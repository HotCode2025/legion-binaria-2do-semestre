...
public class Orden_Comenzamos_con_la_clase_Orden_Parte_3_13_6 {
    private final int idOrden;
    private final Producto_13_2_Creamos_la_clase_Producto productos[]; //Declaramos el arreglo
    static int contadorOrdenes;
    private int contadorProductos;
    static final int MAX_PRODUCTOS = 10;
    
    //Constructor vacio
    public Orden_Comenzamos_con_la_clase_Orden_Parte_3_13_6(){
