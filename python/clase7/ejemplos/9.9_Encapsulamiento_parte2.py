...
class Persona: 
    def __init__(self,nombre,apellido,dni,edad,*args,**kwargs):
        self.nombre = nombre #self.__nombre = nombre_# Es la unica manera de encapsularlo totalmente
...
#persona3.__nombre # Esta totalmente encapsulado y no va a aceptar ningun tipo de cambio ni modificacion.